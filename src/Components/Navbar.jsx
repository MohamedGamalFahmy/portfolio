    ...
    <div>
      <nav className="fixed top-0 w-full bg-gray-800/40 backdrop-blur-sm text-white shadow-md z-50">
        <div className="container max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div>
          <ul className="flex gap-6 xs:invisible  md:visible ">
          ...
          {icon.map((item) => (
            <div id={item.id} className=' xs:justify-center flex gap-2  ' >
              <ul className=' rounded-full '>

                <li className='flex items-center justify-center  w-8 h-8 rounded-full bg-wite hover:scale-150  '>
